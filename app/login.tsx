...
export default function LoginScreen() {
  ...
  const handleForgotPassword = () => {
    toast.info('Password reset is not available in local mode');
  };
  ...
  return (
    <ThemedView className="flex-1">
      ...
      >
        <ThemedText className="text-xl font-bold">Login</ThemedText>
        <Pressable 
          onPress={() => router.back()}
      ...
      <View className="flex-1 px-6 pt-8">
        ...
        <Pressable onPress={handleForgotPassword} className="self-end mb-6">
          <ThemedText className="text-sm font-medium" style={{ color: '#1d4ed8' }}>
            Forgot Password?
          </ThemedText>
        </Pressable>
